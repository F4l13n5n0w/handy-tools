...
cd /opt/
#wget https://github.com/BloodHoundAD/BloodHound/releases/download/4.3.0/BloodHound-linux-x64.zip -O BloodHound-linux-x64.zip
wget https://github.com/BloodHoundAD/BloodHound/releases/download/v4.3.0/BloodHound-linux-x64.zip -O BloodHound-linux-x64.zip
